...
%
% Simula modelo termodinâmico para motores aeronáuticos (turbofan,
% turbojato, ramjet)
%
% Entradas: 
%           type = tipo do motor (turbofan, turbojet, ramjet)
%           params = estrutura contendo os parametros do motor
%           op = ponto de operacao do motor   
